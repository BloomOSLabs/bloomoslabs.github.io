...
export default function TopAppBar () {
  ...
  return (
    <>
      <header
        className={
          scrolled ? 'top-app-bar top-app-bar--floating' : 'top-app-bar'
        }
      >
        <Container>
          <div className='top-app-bar-container'>
            <Link to='/' className='top-app-bar-logo'>
              <svg
              ...
              <span className='top-app-bar-logo-text'>BloomOS</span>
            </Link>
            ...
            <div className='top-app-bar-actions'>
              <div className='top-app-bar-theme'>
                <ThemeToggle />
              </div>
