    ...
    <Section>
      <Container className='section-grid section-grid--hero'>
        <div className='section-inner'>
          <span className='section-badge'>About BloomOS</span>
          ...
          <p className='section-description text-secondary'>
            BloomOS is an open-source Android operating system dedicated to
            delivering practical privacy and security improvements without
            sacrificing performance, usability or thoughtful design. Our
            long-term vision is to provide the strongest protections possible on
            every supported device while remaining transparent, community-driven
            and open source.
          </p>
        ...
        <div className='about-hero-visual'>
          <div className='about-logo-card'>
            ...
            <h3 className='about-logo-title'>BloomOS</h3>

            <p className='about-logo-subtitle'>Beautiful. Fast. Private.</p>
          </div>
        </div>
      </Container>
    </Section>
